...
use cosmwasm_std::{
    ...
    Empty, GovMsg, Querier, QuerierResult, QuerierWrapper, QueryRequest, Storage, SystemError,
...
mod test {
    ...
    //     use cw_utils::parse_reply::parse_instantiate_response_data;
